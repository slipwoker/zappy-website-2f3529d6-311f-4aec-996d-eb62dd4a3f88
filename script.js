    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Forever Young משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '2f3529d6-311f-4aec-996d-eb62dd4a3f88',
                    name: data.name || '',
                    email: data.email || '',
